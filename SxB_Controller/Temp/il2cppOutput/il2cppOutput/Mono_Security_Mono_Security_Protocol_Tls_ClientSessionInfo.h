...
struct  ClientSessionInfo_t962  : public Object_t
{
	...
	ByteU5BU5D_t728* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t728* ___masterSecret_5;
};
struct ClientSessionInfo_t962_StaticFields{
