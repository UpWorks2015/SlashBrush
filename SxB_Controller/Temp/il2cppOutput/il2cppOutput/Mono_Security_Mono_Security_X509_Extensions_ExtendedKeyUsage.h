...
struct  ExtendedKeyUsageExtension_t940  : public X509Extension_t844
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t661 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t940_StaticFields{
	...
	Dictionary_2_t179 * ___U3CU3Ef__switchU24map14_4;
};
