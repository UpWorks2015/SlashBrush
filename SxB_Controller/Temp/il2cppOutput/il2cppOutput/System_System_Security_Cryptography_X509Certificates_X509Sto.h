...
struct  X509Store_t738  : public Object_t
{
	...
	X509Certificate2Collection_t729 * ___list_2;
	...
	X509Store_t752 * ___store_4;
};
struct X509Store_t738_StaticFields{
	...
	Dictionary_2_t179 * ___U3CU3Ef__switchU24mapF_5;
};
